...
class TestRailsMode < Test::Unit::TestCase
  ...
  context "Rails mode" do
    ...
    should "be invalid due to missing maestro directory" do
      Object.const_set("RAILS_ROOT", File.join(File.dirname(__FILE__), 'fixtures', 'invalid-missing-maestro'))
      result = Maestro.validate_configs
      assert !result[0], result[1]
    ...
    should "be invalid due to maestro not a directory" do
      Object.const_set("RAILS_ROOT", File.join(File.dirname(__FILE__), 'fixtures', 'invalid-maestro-not-a-directory'))
      result = Maestro.validate_configs
      assert !result[0], result[1]
    ...
    should "be invalid due to missing clouds directory" do
      Object.const_set("RAILS_ROOT", File.join(File.dirname(__FILE__), 'fixtures', 'invalid-missing-clouds'))
      result = Maestro.validate_configs
      assert !result[0], result[1]
    ...
    should "be invalid due to clouds not a directory" do
      Object.const_set("RAILS_ROOT", File.join(File.dirname(__FILE__), 'fixtures', 'invalid-clouds-not-a-directory'))
      result = Maestro.validate_configs
      assert !result[0], result[1]
    ...
    should "be invalid due to missing cookbooks directory" do
      Object.const_set("RAILS_ROOT", File.join(File.dirname(__FILE__), 'fixtures', 'invalid-missing-cookbooks'))
      result = Maestro.validate_configs
      assert !result[0], result[1]
    ...
    should "be invalid due to cookbooks not a directory" do
      Object.const_set("RAILS_ROOT", File.join(File.dirname(__FILE__), 'fixtures', 'invalid-cookbooks-not-a-directory'))
      result = Maestro.validate_configs
      assert !result[0], result[1]
    ...
    should "be invalid due to missing roles directory" do
      Object.const_set("RAILS_ROOT", File.join(File.dirname(__FILE__), 'fixtures', 'invalid-missing-roles'))
      result = Maestro.validate_configs
      assert !result[0], result[1]
    ...
    should "be invalid due to roles not a directory" do
      Object.const_set("RAILS_ROOT", File.join(File.dirname(__FILE__), 'fixtures', 'invalid-roles-not-a-directory'))
      result = Maestro.validate_configs
      assert !result[0], result[1]
